...
import com.mohiva.play.silhouette.impl.providers.oauth2.{GitLabProvider, GoogleProvider}
...
import models.{OAuth2InfoRepository, PasswordInfoRepository, NewUserRepository}
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  @Provides
  def provideEnvironment(newUserRepository: NewUserRepository,
  ...
  @Provides
  def provideSocialProviderRegistry(googleProvider: GoogleProvider, gitLabProvider: GitLabProvider): SocialProviderRegistry =
    SocialProviderRegistry(Seq(googleProvider, gitLabProvider))
