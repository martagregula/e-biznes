...
import models.{AuthTokenRepository, NewUserRepository}
...
abstract class SilhouetteController(override protected val controllerComponents: DefaultSilhouetteControllerComponents)
  ...
  def newUserRepository: NewUserRepository = controllerComponents.newUserRepository
...
trait SilhouetteComponents {
  ...
  def newUserRepository: NewUserRepository
